...
function UpdateCard() {
    const [updates, setUpdates] = React.useState([
        {id: '1', date: '12.01.2020', action: 'Новый жираф', giraffe: 'Матильда', status: 'Ожидается'},
        {id: '2', date: '12.01.2020', action: 'Редактировать', giraffe: 'Пряник', status: 'Отклонено'},
        {id: '3', date: '12.01.2020', action: 'Удалить', giraffe: 'Лучик', status: 'Не подтвержден'},
        {id: '4', date: '12.01.2020', action: 'Перевод', giraffe: 'Егор', status: 'Отклонено'},
        {id: '5', date: '12.01.2020', action: 'Редактировать', giraffe: 'Пряник', status: 'Отклонено'},
        {id: '6', date: '12.01.2020', action: 'Удалить', giraffe: 'Лучик', status: 'Не подтвержден'},
        {id: '7', date: '12.01.2020', action: 'Перевод', giraffe: 'Егор', status: 'Отклонено'},
        {id: '8', date: '12.01.2020', action: 'Новый жираф', giraffe: 'Шнур', status: 'Выполнено'}
    ])
    ...
    return (
        <div className='background'>
            <div className='updates-top-bar'>
                ...
                <svg className='close-button-svg' width="11" height="11" viewBox="0 0 11 11" fill="none"
